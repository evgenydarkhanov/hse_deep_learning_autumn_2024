...
WEIGHT_DECAY = 0
EPOCHS = 1
LOAD_MODEL_FILE = "./src/model.pth"
FILES_DIR = './src/test_data'
...
def intersection_over_union(boxes_preds, boxes_labels, box_format='midpoint'):
    ...
    if boxes_preds.shape != boxes_labels.shape:
        raise ValueError("boxes_preds and boxes_labels must have the same shape")

    if box_format != 'midpoint' and box_format != 'corners':
        raise NotImplementedError("box_format must be 'midpoint' or 'corners'")
...
def plot_image(image, pred_boxes):
